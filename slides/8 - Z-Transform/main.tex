  ...
  \begin{columns}[T]
    \begin{column}{0.53\textwidth}
      ...
      \begin{align*}
        ...
        = \sum_{n=0}^{\infty} (az^{-1})^n, \qquad |az^{-1}|<1 \\
        &= \frac{1}{1-az^{-1}}
        = \frac{z}{z-a},
        \qquad |z|>|a|.
      \end{align*}
...
\begin{frame}[t]{Power-Series Inversion: Example 10.14}
  ...
  \]
  Integrating from $0$ to $v$ gives
  \[
    \log(1+v)=\int_0^v \frac{1}{1+t}\,dt
    =\int_0^v (1-t+t^2-\cdots)\,dt
    =\sum_{n=1}^{\infty}\frac{(-1)^{n+1}v^n}{n},
    \qquad |v|<1.
  \]
  Now set $v=az^{-1}$. Since $|z|>|a|$, we have $|az^{-1}|<1$, so
  \[
